...
class ProductBatch {
    ...
    factory ProductBatch.fromJson(Map<String, dynamic> json) => ProductBatch(
        create: List<Create>.from(json["create"].map((x) => Create.fromJson(x))),
        update: List<Create>.from(json["update"].map((x) => Create.fromJson(x))),
        delete: List<Create>.from(json["delete"].map((x) => Create.fromJson(x))),
    );
